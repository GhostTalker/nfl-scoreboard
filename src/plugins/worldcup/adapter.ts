...
export class WorldCupAdapter implements SportAdapter {
  sport = 'worldcup' as const;
  ...
  private buildClock(match: TournamentMatch, goals: Goal[]): SoccerClock {
    ...
    // World Cup matches can have extra time in knockout stages
  ...
  private transformTeam(team: TournamentTeam, score: number): Team {
    ...
    const color = WORLDCUP_TEAM_COLORS[team.teamId] || 'B8860B'; // Default gold for World Cup
